...
<div id="header-wrapper">
	<div class="container">
		<div class="row">
			<div class="12u">
				<header id="header">
					<h1><a href="home.jsp" id="logo"><img width=38 height=63 src="http://i.cdn.turner.com/nba/tmpl_asset/static/nba-cms3-homepage/1577/elements/global/nba-logo.png">NBA 2016</a></h1>
					<nav id="nav">
						<%-- 
						<a href="../main.jsp" <%=(currpage.equals("home")?"class='current-page-item'":"") %>>Home</a>
						--%>
						<a href="../home.jsp" <%=(currpage.equals("home")?"class='current-page-item'":"") %>>Home</a>
						<a href="bets.jsp"  <%=(currpage.equals("bets")?"class='current-page-item'":"") %>>Apostas</a>
						<a href="leaderboard.jsp" <%=(currpage.equals("leaderboard")?"class='current-page-item'":"") %>>Leaderboard</a>
			<%
