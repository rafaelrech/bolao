...
public class Nba2016DBUtil {
	...
	public static final String USER_BEAN = "NBA2016-USER";
	public static final String GAME_BEAN = "NBA2016-GAME";
	public static final String SERIES_BEAN = "NBA2016-SERIES";
	public static final String TIE_BREAKER_BEAN = "NBA2016-TB";
	public static final String GAME_BET_BEAN = "NBA2016-GAME-BET";
	public static final String SERIES_BET_BEAN = "NBA2016-SERIES-BET";
	public static final String TB_BET_BEAN = "NBA2016-TB-BET";
	
	public static final String[] beans = { USER_BEAN, GAME_BEAN, SERIES_BEAN, TIE_BREAKER_BEAN, GAME_BET_BEAN , SERIES_BET_BEAN , TB_BET_BEAN };
	...
	public static CommonDao<?> getDaoFromBean(String bean) {
		if (bean.equals(USER_BEAN)) {
			return Nba2016UserDao.getInstance();
		}
		if (bean.equals(GAME_BEAN)) {
			return Nba2016GameDao.getInstance();
		}
		if (bean.equals(SERIES_BEAN)) {
			return Nba2016SeriesDao.getInstance();
		}
		if (bean.equals(TIE_BREAKER_BEAN)) {
			return Nba2016TieBreakerDao.getInstance();
		}
		if (bean.equals(GAME_BET_BEAN)) {
			return Nba2016GameBetDao.getInstance();
		}
		if (bean.equals(SERIES_BET_BEAN)) {
			return Nba2016SeriesBetDao.getInstance();
		}
		if (bean.equals(TB_BET_BEAN)) {
			return Nba2016TieBreakerBetDao.getInstance();
		}
		return null;
	}
